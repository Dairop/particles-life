...
void display(const sf::Vector2f& sizeEnv, std::vector<particle*> vectParticles, quadtree& quad) { // les donn�es � affich�es sont pass�es par r�f�rence en param�tre dans cette fonction depuis le main 
